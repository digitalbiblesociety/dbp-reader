...
class AppContainer extends React.Component {
  ...
  componentDidMount() {
    ...
    console.log('profile in did mount', this.props.userProfile.userId);
    ...
    if (this.props.userProfile.userId) {
      ...
      // 	this.props.userProfile.name,
      // );
      console.log('updating store in did mount');
      this.props.dispatch({
...
AppContainer.getInitialProps = async (context) => {
  ...
  console.log('user profile get initial', userId, userProfile);
  ...
  if (context.reduxStore) {
    ...
    if (userProfile.userId && userProfile.email) {
      console.log(
        'updating profile in redux store initial',
        userProfile.userId,
      );
