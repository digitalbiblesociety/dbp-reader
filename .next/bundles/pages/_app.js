module.exports = __NEXT_REGISTER_PAGE('/_app', function() {
	var comp = webpackJsonp(
		[2],
		{
			/***/ './node_modules/@babel/runtime/helpers/extends.js': /***/ function(
				module,
				exports,
				__webpack_require__,
			) {
			...
			/***/ './node_modules/next/app.js': /***/ function(
				module,
				exports,
				__webpack_require__,
			) {
			...
			/***/ './node_modules/next/dist/lib/app.js': /***/ function(
				module,
				exports,
				__webpack_require__,
			) {
				...
				var _getPrototypeOf = _interopRequireDefault(
					__webpack_require__(
				...
				var _shallowEquals = _interopRequireDefault(
					__webpack_require__('./node_modules/next/dist/lib/shallow-equals.js'),
				);
					...
					(function(_Component) {
						...
						function App() {
							...
							return (0, _possibleConstructorReturn2.default)(
								this,
								(App.__proto__ || (0, _getPrototypeOf.default)(App)).apply(
									this,
									arguments,
								),
							);
							...
							[
								{
									...
									value: function getChildContext() {
										...
										return {
											...
											_containerProps: (0, _objectSpread2.default)(
												{},
												this.props,
											),
										};
					...
					(function(_Component2) {
						...
						function Container() {
							...
							return (0, _possibleConstructorReturn2.default)(
								this,
								(
									Container.__proto__ || (0, _getPrototypeOf.default)(Container)
			...
			/***/ './node_modules/next/dist/pages/_app.js': /***/ function(
				module,
				exports,
				__webpack_require__,
			) {
