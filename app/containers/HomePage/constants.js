...
export const TOGGLE_FIRST_LOAD_TEXT_SELECTION =
	'app/HomePage/TOGGLE_FIRST_LOAD_TEXT_SELECTION';
...
export const SET_SELECTED_BOOK_NAME =
	'app/TextSelection/SET_SELECTED_BOOK_NAME';
...
export const TOGGLE_ONE_VERSE_PER_LINE =
	'app/Settings/TOGGLE_ONE_VERSE_PER_LINE';
export const TOGGLE_VERTICAL_SCROLLING =
	'app/Settings/TOGGLE_VERTICAL_SCROLLING';
export const SET_CHAPTER_TEXT_LOADING_STATE =
	'app/HomePage/SET_CHAPTER_TEXT_LOADING_STATE';
...
export const TOGGLE_SETTINGS_OPTION_AVAILABILITY =
	'app/HomePage/TOGGLE_SETTINGS_OPTION_AVAILABILITY';
