...
//       expect(typeof wrapper.instance().addHighlight === 'function').toEqual(
//         true,
//       );
//     });
...
//       const mountWrap = mount(
//         <Text
//           {...jsonProps.verseHasHighlight}
//           formattedSource={fromJS(jsonProps.verseHasHighlight.formattedSource)}
//           userSettings={fromJS(jsonProps.verseHasHighlight.userSettings)}
//         />,
//       );
