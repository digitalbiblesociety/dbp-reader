...
describe('highlightPlainText', () => {
	...
	xit('Case 1: It should highlight the text for a single highlight in one verse', () => {
		...
		const result = [
			{
				...
				verse_end: 1,
				verse_end_alt: '1',
				verse_text: `I <em class="text-highlighted" style="background:linear-gradient(rgba(${
	...
	xit('Case 2: It should handle a highlight that contains another highlight and use the color of the longer highlight', () => {
		...
		const result = [
			{
				...
				verse_end_alt: '2',
				hasHighlight: true,
				verse_text: `The<em class="text-highlighted" style="background:linear-gradient(rgba(${
	...
	xit('Case 3: It should handle a multi-verse highlight', () => {
		...
		const result = [
			{
				...
				verse_end_alt: '3',
				hasHighlight: true,
				verse_text: `<em class="text-highlighted" style="background:linear-gradient(rgba(${
					sampleHighlights[0].highlighted_color
				}),rgba(${
					sampleHighlights[0].highlighted_color
	...
	xit('Case 4: It should apply two non-overlapping highlights in the same verse', () => {
		...
		const result = [
			{
				...
				verse_end_alt: '6',
				hasHighlight: true,
				verse_text: `In my <em class="text-highlighted" style="background:linear-gradient(rgba(${
					sampleHighlights[0].highlighted_color
				}),rgba(${
					sampleHighlights[0].highlighted_color
				}))">distress</em> I called upon t<em class="text-highlighted" style="background:linear-gradient(rgba(${
					sampleHighlights[1].highlighted_color
				}),rgba(${
					sampleHighlights[1].highlighted_color
	...
	xit('Case 5: It should stop the first highlight at the beginning of the next when they both are multi-verse and neither contains the other', () => {
		...
		const result = [
			...
			},
			{
				...
				verse_text: `<em class="text-highlighted" style="background:linear-gradient(rgba(${
					...
					sampleHighlights[0].highlighted_color
				}))">He bowed the heavens and came down; thick darkness was under his </em><em class="text-highlighted" style="background:linear-gradient(rgba(${
					sampleHighlights[1].highlighted_color
				}),rgba(${
					sampleHighlights[1].highlighted_color
				}))"><em class="text-highlighted" style="background:linear-gradient(rgba(${
					sampleHighlights[0].highlighted_color
				}),rgba(${sampleHighlights[0].highlighted_color}))">feet.</em></em>`,
			},
			{
				book_id: 'PSA',
				book_name: 'Psalm',
	...
	xit('Case 6: It should apply a multi-verse highlight correctly when there is a non-overlapping highlight in the ending verse', () => {
		...
		const result = [
			...
			},
			{
				...
				verse_text: `<em class="text-highlighted" style="background:linear-gradient(rgba(${
					...
					sampleHighlights[0].highlighted_color
				}))">The LORD also thundered</em> in the heavens, and <em class="text-highlighted" style="background:linear-gradient(rgba(${
					sampleHighlights[1].highlighted_color
				}),rgba(${
					sampleHighlights[1].highlighted_color
	...
	xit('Case 7: It should apply two overlapping highlights where newest highlight take priority', () => {
		const sampleHighlights = [
			{
				id: 262,
				bible_id: 'ENGESV',
		...
		const result = [
			{
				...
				verse_text: `<em class="text-highlighted" style="background:linear-gradient(rgba(${
					...
					sampleHighlights[0].highlighted_color
				}))">Out of the <em class="text-highlighted" style="background:linear-gradient(rgba(${
					sampleHighlights[1].highlighted_color
				}),rgba(${
					sampleHighlights[1].highlighted_color
	...
	xit('Case 8: It should apply a newer highlight over the top of two pre-existing highlights where the new highlight starts at the same index as the first one and ends at the same index of the second', () => {
		const sampleHighlights = [
			{
				id: 262,
				bible_id: 'ENGESV',
		...
		const result = [
			{
				...
				verse_text: `<em class="text-highlighted" style="background:linear-gradient(rgba(${
					...
					sampleHighlights[0].highlighted_color
				}))">Out</em> of the <em class="text-highlighted" style="background:linear-gradient(rgba(${
					sampleHighlights[1].highlighted_color
				}),rgba(${
					sampleHighlights[1].highlighted_color
				}))">brightness</em></em> before him hailstones and coals of fire broke through his clouds.`,
	...
	xit('Case 9: It should apply a highlight contained within an older highlight where the new highlight is on top of the old one and they are the same color', () => {
		const sampleHighlights = [
			{
				bible_id: 'ENGESV',
		...
		const result = [
			{
				...
				verse_text: `<em class="text-highlighted" style="background:linear-gradient(rgba(${
					...
					sampleHighlights[0].highlighted_color
				}))">The <em class="text-highlighted" style="background:linear-gradient(rgba(${
					sampleHighlights[1].highlighted_color
				}),rgba(${
					sampleHighlights[1].highlighted_color
	...
	xit('Case 10: It should apply a highlight contained within an older highlight where the new highlight is on top of the old one and they are NOT the same color', () => {
		const sampleHighlights = [
			{
				bible_id: 'ENGESV',
				reference: 'Matthew 1:1',
		...
		const result2 = [
			{
				...
				verse_end_alt: '13',
				hasHighlight: true,
				verse_text: `and <em class="text-highlighted" style="background:linear-gradient(rgba(${
	...
	xit('Case 11: It should apply a newer highlight over the top of two pre-existing highlights where the new highlight does not start at the same index as the first one and does not end at the same index of the second', () => {
		const sampleHighlights = [
			{
				id: 262,
				bible_id: 'ENGESV',
		...
		const result = [
			{
				...
				verse_text: `<em class="text-highlighted" style="background:linear-gradient(rgba(${
					...
					sampleHighlights[2].highlighted_color
				}))">Out<em class="text-highlighted" style="background:linear-gradient(rgba(${
					sampleHighlights[0].highlighted_color
				}),rgba(${
					sampleHighlights[0].highlighted_color
				}))"> of the </em><em class="text-highlighted" style="background:linear-gradient(rgba(${
					sampleHighlights[1].highlighted_color
				}),rgba(${
					sampleHighlights[1].highlighted_color
